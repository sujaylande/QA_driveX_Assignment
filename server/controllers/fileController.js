...
const uploadFiles = async (req, res) => {
  try {
    ...
    const document = new Document({ title: combinedTitle, textContent: combinedTextContent, userId: req.user.userId });
    await document.save();
...
const uploadDriveLink = async (req, res) => {
  try {
    ...
    const document = new Document({ title: newFileName, textContent: textContent, userId: req.user.userId });
    await document.save();
